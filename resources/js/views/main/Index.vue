                        ...
                        <div class="newsLetter-popup__content mb-4">
                            ...
                            <form action="#0" class="newsLetter-popup__subscrib-form">
                                <div class="input_box"> <input type="email" placeholder="Enter your email Address"
                                        name="email"> <button type="submit" class="subscribe_btn"> Submit </button>
                                </div>
                                <div class="form-group "> <input type="checkbox" id="html"> <label for="html"> By
                                        providing
                                        my information, I agree to Karte <a href="#0"> Privacy Policy</a> and <a
                                            href="#0">
                                        ...
                                        <div class="content">
                                            <div class="row w-100 h-100 align-items-center">
                                                <div class="col-12">
                                                    ...
                                                    <span class="link wow animated fadeInUp" data-wow-delay="0.4s">
                                                        explore
                                                        now</span>
                                                </div>
                                            </div>
                        ...
                        <div class="col-12">
                            <ul class="nav three nav-pills justify-content-center" id="pills-tab-two" role="tablist">
                                ...
                                <li class="nav-item" role="presentation"> <button class="nav-link"
                                        id="pills-top-rated-tab" data-bs-toggle="pill" data-bs-target="#pills-top-rated"
                                        type="button" role="tab" aria-controls="pills-top-rated" aria-selected="false">
                                        Top Rated </button> </li>
                            </ul>
                        </div>
                    </div>
                                        ...
                                        <div class="products-three-single w-100">
                                            <div class="products-three-single-img">
                                                ...
                                                <div class="products-grid-one__badge-box"> <span
                                                    ...
                                                    href="cart.html" class="addcart btn--primary style2"> Add To Cart
                                                </a>
                                    ...
                                    <div class="products-three__inner">
                                        <div class="products-three-single w-100">
                                            <div class="products-three-single-img">
                                                ...
                                                <a href="cart.html" class="addcart btn--primary style2"> Add To Cart
                                                </a>
                                                <div class="products-grid__usefull-links">
                                                    <ul>
                                                        <li><a href="wishlist.html"> <i class="flaticon-heart"> </i>
                                    ...
                                    <div class="products-three__inner">
                                        <div class="products-three-single w-100">
                                            <div class="products-three-single-img img-bg">
                                                ...
                                                </div> <a href="cart.html" class="addcart btn--primary style2"> Add To
                                                    Cart </a>
                                                <div class="products-grid__usefull-links">
                                                    <ul>
                                                        <li><a href="wishlist.html"> <i class="flaticon-heart"> </i>
                                ...
                                <ul>
                                    ...
                                    <li class="products-three-single wow fadeInUp animated">
                                        <div class="products-three-single-img">
                                            <a href="shop-details-3.html" class="d-block"> <img
                                                    ...
                                                    alt="" /> <img
                                                    src="@/assets/images/home-three/productss2-hover-1.png" alt=""
                                                    class="hover-img" /> </a>
                                            <div class="products-grid-one__badge-box"> <span
                                                    class="bg_base badge new ">New</span> </div> <a href="cart.html"
                                                class="addcart btn--primary style2"> Add To Cart </a>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="popup-right-content">
                                                            ...
                                                            <div class="color-varient"> <a href="#0"
                                                                ...
                                                                <a href="#0" class="color-name red"> <span>Red</span>
                                                                </a>
                                                                <a href="#0"
                                    ...
                                    <li class="products-three-single wow fadeInUp animated">
                                        <div class="products-three-single-img">
                                            ...
                                            <div class="products-grid-one__badge-box"> <span
                                                    class="bg_black badge discount">-70%</span>
                                            </div> <a href="cart.html" class="addcart btn--primary style2"> Add To Cart
                                            </a>
                                            <div class="products-grid__usefull-links">
                                                <ul>
                                                    <li><a href="wishlist.html"> <i class="flaticon-heart"> </i> <span>
                            ...
                            <div class="col-xxl-3 col-md-6 wow fadeInUp animated">
                                <div class="products-cetagory-three__single height-400 style2">
                                    <div class="inner h-100">
                                        ...
                                        <div class="btn-box"> <a href="cart.html" class="button">Code: LOVEBITE</a>
                                        </div>
                            ...
                            <div class="reviewOneSlider owl-carousel">
                                <div class="review-one__single-review">
                                    <div class="review-one__single-content">
                                        <div class="review-one__aurthor">
                                            <div class="thumb"> <img
                                                    src="@/assets/images/testimonial/testimonial-v1-1.png" alt="">
                                            </div>
                                ...
                                <div class="review-one__single-review">
                                    <div class="review-one__single-content">
                                        <div class="review-one__aurthor">
                                            <div class="thumb"> <img
                                                    src="@/assets/images/testimonial/testimonial-v1-2.png" alt="">
                                            </div>
                                            <span class="quate"> <i class="flaticon-right-quotes-symbol"></i> </span>
                                        </div>
                                        <div class="review-one__review-text">
                                ...
                                <div class="review-one__single-review">
                                    <div class="review-one__single-content">
                                        <div class="review-one__aurthor">
                                            <div class="thumb"> <img
                                                    src="@/assets/images/testimonial/testimonial-v1-3.png" alt="">
                                            </div>
                                            <span class="quate"> <i class="flaticon-right-quotes-symbol"></i> </span>
                                        </div>
                                        <div class="review-one__review-text">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-xl-4 col-lg-4 col-sm-6 wow fadeInUp animated">
                            <div class="blog-three__single mt-30"> <a href="blog-single.html"
                                    ...
                                    <img src="@/assets/images/blog/blog-v3-2.jpg" alt="" /> </a>
                                <div class="blog-three__single-content text-center"> <span>Vendora Style</span>
                        ...
                        <div class="col-xl-4 col-lg-4 col-sm-6 wow fadeInUp animated">
                            <div class="blog-three__single mt-30"> <a href="blog-single.html"
                                    class="blog-three__single-img d-block">
                                    <img src="@/assets/images/blog/blog-v3-3.jpg" alt="" /> </a>
                                <div class="blog-three__single-content text-center"> <span>Vendora Style</span>
                                    <h4><a href="blog-single.html">What men's shoes will be in fashion in the spring
                                        </a>
                                    </h4>
                                    <div class="btn-box"> <a href="blog-single.html">Read More</a> </div>
                                </div>
                        ...
                        <div class="col-xl-12">
                            <div class="gallery-two__slider "> <a href="@/assets/images/home-three/gallery-v2-img1.jpg"
                                    class="gallery-two__single"> <img
                                        src="@/assets/images/home-three/gallery-v2-img1.jpg" alt="" />
                                    <span class="zoom-icon"> <i class="flaticon-expand"></i> </span> </a> <a
                                    href="@/assets/images/home-three/gallery-v2-img2.jpg" class="gallery-two__single">
                                    <img src="@/assets/images/home-three/gallery-v2-img2.jpg" alt="" /> <span
                                        class="zoom-icon"> <i class="flaticon-expand"></i> </span> </a> <a
                                    href="@/assets/images/home-three/gallery-v2-img3.jpg" class="gallery-two__single">
                                    <img src="@/assets/images/home-three/gallery-v2-img3.jpg" alt="" /> <span
                                        class="zoom-icon"> <i class="flaticon-expand"></i> </span> </a> <a
                                    href="@/assets/images/home-three/gallery-v2-img4.jpg" class="gallery-two__single">
                                    <img src="@/assets/images/home-three/gallery-v2-img4.jpg" alt="" /> <span
                                        class="zoom-icon"> <i class="flaticon-expand"></i> </span> </a> <a
                                    href="@/assets/images/home-three/gallery-v2-img5.jpg" class="gallery-two__single">
                                    <img src="@/assets/images/home-three/gallery-v2-img5.jpg" alt="" /> <span
                                        class="zoom-icon"> <i class="flaticon-expand"></i> </span> </a> <a
                                    href="@/assets/images/home-three/gallery-v2-img6.jpg" class="gallery-two__single">
                                    <img src="@/assets/images/home-three/gallery-v2-img6.jpg" alt="" /> <span
                                        class="zoom-icon"> <i class="flaticon-expand"></i> </span> </a> <a
                                    href="@/assets/images/home-three/gallery-v2-img2.jpg" class="gallery-two__single">
                                    <img src="@/assets/images/home-three/gallery-v2-img2.jpg" alt="" /> <span
                                        class="zoom-icon"> <i class="flaticon-expand"></i> </span> </a> <a
